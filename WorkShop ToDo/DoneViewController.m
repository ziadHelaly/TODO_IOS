...
- (void)categorizeTasks {
    ...
    if (encoded) {
        ...
        _savedTasks = [[unarchivedTasks filteredArrayUsingPredicate:[NSPredicate predicateWithFormat:@"status == 2"]] mutableCopy];
    ...
    _high = [_savedTasks filteredArrayUsingPredicate:[NSPredicate predicateWithFormat:@"priority == 0 AND status == 2"]];
    _medium = [_savedTasks filteredArrayUsingPredicate:[NSPredicate predicateWithFormat:@"priority == 1 AND status == 2"]];
    _low = [_savedTasks filteredArrayUsingPredicate:[NSPredicate predicateWithFormat:@"priority == 2 AND status == 2"]];
